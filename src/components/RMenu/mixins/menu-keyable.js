...
export default {
  ...
  watch: {
    ...
    listIndex (next, prev) {
      ...
      prev in this.tiles &&
        this.tiles[prev].classList.remove('list__tile_highlighted');
    }
  },
  ...
  methods: {
    ...
    getTiles () {
      ...
      const basicList = content.querySelectorAll('.list__tile');
      const selectableList = content.querySelectorAll('.list__tile_selectable');
